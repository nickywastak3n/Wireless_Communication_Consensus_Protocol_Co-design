% Calculates single dissemination energy for gossip protocol
function Z = dissemination_energy_gossip(N, source, outage_probability)
    ...
    Z = 0; % Total dissemination energy time
    while true
        next_system = system;
